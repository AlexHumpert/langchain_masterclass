...
# Used file main_05.py to create local SQLite database directory storing the embeddings
...
# Creating chat model instance (i.e. more conversational)
chat = ChatOpenAI()
...
# Creating retriever instance so it can be passed as an argument to our chain
